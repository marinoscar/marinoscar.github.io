...
In a recent discussion, Alex Wang made a point that resonates strongly with what many organizations are experiencing in practice: **the real competitive advantage in AI is no longer just compute or algorithms, it is access to data** ([watch the clip](https://youtu.be/jNbEr9F0wiE?t=218)). Models are becoming more capable and increasingly interchangeable, but the data they are trained on and reason over remains highly differentiated.
...
1. **Compute** – the infrastructure that powers training and inference
2. **Algorithms** – the models, architectures, and reasoning techniques
3. **Data** – the information used to train, ground, and guide those models
...
Knowledge graphs connect it.
Semantic models operationalize it.
